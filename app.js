...
async function loadHistory(){
  ...
  }catch(e){console.error(e);list.className='history-list empty';list.textContent='Historik kunne ikke hentes. Kontroller at v16 og v17 SQL-opdateringerne er kørt i Supabase.'}
}
