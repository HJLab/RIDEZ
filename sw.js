const CACHE='ridez-vehicles-v89';
const CORE=['./','./index.html','./styles.css?v=89','./app.js?v=89','./RIDEZ_Sportsbike_4-8sek.wav?v=89','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
