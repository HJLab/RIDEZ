const CACHE='ridez-beskeder-v75';
const CORE=['./','./index.html','./styles.css?v=75','./app.js?v=75','./RIDEZ_Sportsbike_4-8sek.wav?v=75','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
