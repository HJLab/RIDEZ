const CACHE='ridez-trip-length-v93';
const CORE=['./','./index.html','./styles.css?v=93','./app.js?v=93','./RIDEZ_Sportsbike_4-8sek.wav?v=93','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
