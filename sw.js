const CACHE='ridez-vehicles-v90';
const CORE=['./','./index.html','./styles.css?v=90','./app.js?v=90','./RIDEZ_Sportsbike_4-8sek.wav?v=90','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
