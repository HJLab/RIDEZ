const CACHE='ridez-vehicles-v81';
const CORE=['./','./index.html','./styles.css?v=81','./app.js?v=81','./RIDEZ_Sportsbike_4-8sek.wav?v=81','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
