const CACHE='ridez-vehicles-v83';
const CORE=['./','./index.html','./styles.css?v=83','./app.js?v=83','./RIDEZ_Sportsbike_4-8sek.wav?v=83','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
