const CACHE='ridez-profile-v86';
const CORE=['./','./index.html','./styles.css?v=86','./app.js?v=86','./RIDEZ_Sportsbike_4-8sek.wav?v=86','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
