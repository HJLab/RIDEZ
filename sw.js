const CACHE='ridez-profile-v87';
const CORE=['./','./index.html','./styles.css?v=87','./app.js?v=87','./RIDEZ_Sportsbike_4-8sek.wav?v=87','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
