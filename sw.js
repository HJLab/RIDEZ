const CACHE='ridez-vehicles-v88';
const CORE=['./','./index.html','./styles.css?v=88','./app.js?v=88','./RIDEZ_Sportsbike_4-8sek.wav?v=88','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
