const CACHE='ridez-stable-demo-v100';
const CORE=['./','./index.html','./styles.css?v=100','./app.js?v=100','./RIDEZ_Sportsbike_4-8sek.wav?v=100','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
