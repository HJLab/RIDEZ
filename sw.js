const CACHE='ridez-fuel-history-v105';
const CORE=['./','./index.html','./styles.css?v=103','./app.js?v=103','./RIDEZ_Sportsbike_4-8sek.wav?v=103','./config.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
