const CACHE='ridez-beskedtest-v74';
const CORE=['./','./index.html','./styles.css?v=74','./app.js?v=74','./RIDEZ_Sportsbike_4-8sek.wav?v=74','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
