const CACHE='ridez-multiday-v96';
const CORE=['./','./index.html','./styles.css?v=96','./app.js?v=96','./RIDEZ_Sportsbike_4-8sek.wav?v=96','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
