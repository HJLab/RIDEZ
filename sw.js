const CACHE='ridez-fuel-height-v97';
const CORE=['./','./index.html','./styles.css?v=97','./app.js?v=97','./RIDEZ_Sportsbike_4-8sek.wav?v=97','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
