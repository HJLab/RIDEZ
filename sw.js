const CACHE='ridez-username-v78';
const CORE=['./','./index.html','./styles.css?v=78','./app.js?v=78','./RIDEZ_Sportsbike_4-8sek.wav?v=78','./config.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
