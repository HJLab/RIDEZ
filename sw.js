const CACHE='ridez-fuel-history-v109';
const CORE=['./','./index.html','./styles.css?v=109','./app.js?v=109','./RIDEZ_Sportsbike_4-8sek.wav?v=109','./config.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
