-- RIDEZ Chat-brugernavne v79
-- Koer denne fil EN GANG i Supabase SQL Editor.
-- Nye svar fra foereren gemmes med foererens valgte RIDEZ-brugernavn.

create or replace function public.ridez_driver_reply_v79(
  p_driver_token text,
  p_message_id bigint,
  p_sender_name text,
  p_body text
...
grant execute on function public.ridez_driver_reply_v79(text,bigint,text,text) to anon;
